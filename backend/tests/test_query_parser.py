"""Ported from spike/tests/test_query_parser.py (Step 6 Sub-step 5), import path only."""
...
def test_extract_date_matches_irregular_pdf_extraction_spacing():
    # Real ingested table text has irregular whitespace around 年/月/日, e.g. "2024 年8 月21 日".
