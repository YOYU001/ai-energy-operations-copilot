"""Tests for Step 10 Sub-step 2 chunking strategies.

Ported from spike/tests/test_chunker.py (Step 6 Sub-step 3/8), import path
and fixture-path depth only.
"""
...
from app.services.pdf_parser import PageParseResult, parse_pdf_pages
