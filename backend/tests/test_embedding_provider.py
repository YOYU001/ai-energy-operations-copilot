"""Tests for Step 10 Sub-step 2 embedding provider (mocked client, no network).

Ported from spike/tests/test_embedding_provider.py (Step 6 Sub-step 4),
import path only.
"""

import pytest

from app.services.embedding_provider import EmbeddingBatchError, OpenAIEmbeddingProvider
