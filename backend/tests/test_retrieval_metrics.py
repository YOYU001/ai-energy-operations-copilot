"""Ported from spike/tests/test_retrieval_metrics.py (Step 6 Sub-step 7),
import path + production field names (file_name/content, not filename/text)."""
...
def test_exact_content_correctness_uses_full_text_not_a_truncated_preview():
    # The spike Sub-step 5 bug: a 150-char preview of this text would only
    # show "...8月21日..." and a human reviewer would (wrongly) conclude the
...
def test_evaluate_candidate_combines_all_three_dimensions():
    candidate = {"file_name": "doc3.pdf", "pdf_page_number_start": 63, "pdf_page_number_end": 63, "content": "2024 年8 月30 日"}
